...
|----------|-------------|
| `vmforge create <nom>` | Créer une nouvelle VM |
| `vmforge list` | Lister toutes les VMs |
| `vmforge ssh <nom>` | Se connecter en SSH |
| `vmforge delete <nom>` | Supprimer une VM |
| `vmforge inventory` | Générer un inventaire Ansible |
| `vmforge base list` | Télécharger/choisir l'image Alpine de base |
