...
| Paquet | Description |
|--------|-------------|
| `hashdeep` | Calcul récursif et vérification de checksums multiples (MD5, SHA1, SHA256, Tiger) |
...
| `kitty` | Terminal GPU ultra-rapide avec support des ligatures, images et protocole Kitty |
...
|------|--------|-------------|
| `yazi` | `--classic` | Gestionnaire de fichiers terminal ultra-rapide avec prévisualisation d'images, PDF et archives. Intégration Git, plugins communautaires (starship, lazygit). Accès à l'ensemble du système de fichiers grâce au mode classic |
...
| `glow` | Binaire GitHub (Charm) | Rendu Markdown enrichi dans le terminal avec pager et support des stickers |
