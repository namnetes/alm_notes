...
-   :material-cog-outline: **[Finitions manuelles](finitions-manuelles.md)**

    Réglages restant à faire à la main après `sudo make all` :
    Ubuntu Pro, terminal, Nautilus, Firefox.
