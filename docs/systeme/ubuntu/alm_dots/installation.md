...
| Starship | via [alm_tools](../alm_tools/postinstall/post-installation.md) — étape 9 |
| eza | via [alm_tools](../alm_tools/postinstall/post-installation.md) — étape 8 |
| fnm / Node.js | via [alm_tools](../alm_tools/postinstall/post-installation.md) — étapes 14-15 |
| uv | via [alm_tools](../alm_tools/postinstall/post-installation.md) — étape 6 |
| Zed | via [alm_tools](../alm_tools/postinstall/post-installation.md) — étape 16 |
